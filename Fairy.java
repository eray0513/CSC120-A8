...
public class Fairy implements Contract {
  ...
  /**
   * Checks if the fairy can move in a certain direction (cannot have negative coordinates)
   * @param direction North, South, East, or West for intended direction
   * @return t/f if the fairy can move
   */
  ...
  /**
   * Checks if the fairy has enough pixie dust remaining
   * @param pixieNeeded amount of pixie dust required
   * @return t/f if the fairy has enough pixie dust
   */
  ...
  public static void main(String[] args) {
    ...
    // Tests the grab and drop methods
    ...
    // Tests examine methods on all talents
    ...
    // Test using pixie dust
    tinkerbell.use("Pixie Dust");

    // Test walk method with different directions
    ...
    // Test fly method to run out of pixie dust
    try {
    ...
    // Test growing and shrinking methods
